                ...
                @auth()
                    <div class="user-menu-account ">
                        <div class="user-image">
                            <img src="{{ auth()->user()->image != '' ? '/storage/'.auth()->user()->image : '/assets/panel/img/pro.jpg' }}" alt="desction">
                        </div>
                        ...
                        <div class="user-menu-account-dropdown">
                            <ul>
                                ...
                                <li onclick="document.getElementById('logout-form').submit()">
                                    <form action="{{ route('logout') }}" method="post" id="logout-form" class="cursor-pointer" style="display: contents">
                                        @csrf
    ...
    <nav id="navigation" class="navigation">
        @auth()
            <div class="after-login d-none">
                ...
                <a href="">داشبورد</a>
                <a href="{{ route('logout') }}" onclick="document.getElementById('logout-form').submit()">خروج</a>
...
{{--                           @if($category->parent_id == $category->id)--}}
                                @foreach($category->parent_id as $subcategory)
                                    <div class="sub-menu">
                                        <div class="container">
