    ...
    <nav role="navigation" aria-label="{{ __('Pagination Navigation') }}" class="flex items-center justify-between">
        ...
        <div class="hidden sm:flex-1 sm:flex sm:items-center sm:justify-between">
           <div class="d-flex">
                    ...
                    @foreach ($elements as $element)
                        ...
                        @if (is_string($element))
                            <span aria-disabled="true">
                                <span style="padding: 3px;border: 1px solid white;border-radius: 3px;"
                        ...
                        @if (is_array($element))
                            @foreach ($element as $page => $url)
                                ...
                                @else
                                    <a href="{{ $url }}" style="padding: 3px;border: 1px solid white;border-radius: 3px;"
               ...
               <div class="flex justify-between flex-1 sm:hidden" style="margin-right: 10px">
                   @if ($paginator->onFirstPage())
                       <span style="padding: 3px;border: 1px solid white;border-radius: 3px;"
                   ...
                   @else
                       <a style="padding: 3px;border: 1px solid white;border-radius: 3px;"
